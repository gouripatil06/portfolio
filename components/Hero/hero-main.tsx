...
export default function HeroMain() {
  const handleClick = () => {
    const email = process.env.NEXT_PUBLIC_TO_EMAIL || '01fe23bcs022@kletech.ac.in';
  ...
  return (
    <section className='relative flex h-min w-full flex-none flex-col flex-nowrap items-center justify-start gap-5 overflow-visible p-0 lg:flex-row'>
      ...
      <div className='relative flex h-auto w-full flex-col items-start gap-2 p-0'>
        ...
        >
          Aspiring Full-Stack Web Developer from Hubli | 5th Semester Computer Science Student at KLE Technological University. 
          Passionate about Web Technologies and Software Engineering, building modern web applications with HTML, CSS, JavaScript, React, Node.js, and Express.js.
        </motion.p>
